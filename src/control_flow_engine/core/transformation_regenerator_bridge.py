...
class RegenerationBridge:
    ...
    def regenerate_after_transformation(
        ...
        """
        logger.info(f"Starting orchestrator regeneration after {plan.transformation_type.value}")
        ...
        logger.info(f"Regeneration complete: {len(self.results['regenerated'])} succeeded, "
        ...
        for mapping in plan.mappings:
            if mapping.element_type == 'phase':
                ...
                if mapping.operation in ['insert', 'delete', 'renumber']:
                    ...
                    global_orch = self.project_base_path / "phases" / "phases_orchestrator.py"
