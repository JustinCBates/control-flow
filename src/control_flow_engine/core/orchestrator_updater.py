...
class OrchestratorUpdater:
    ...
    def _add_step_execution(self, step: StepIntegration) -> bool:
        ...
        for i in range(execute_start, len(self.lines)):
            ...
            if 'TODO: Implement phase logic' in line or 'TODO: Add phase-specific results' in line:
                insertion_point = i
                break
        ...
        if step.step_class_name in '\n'.join(self.lines[execute_start:insertion_point + 10]):
    ...
    def _generate_step_execution(self, step: StepIntegration, base_indent: str) -> List[str]:
        """
