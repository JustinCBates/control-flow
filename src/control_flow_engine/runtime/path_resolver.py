...
class PathResolver:
    ...
    def _build_indexes(self):
        ...
        logger.debug(f"Indexed {len(self._artifact_cache)} artifacts from control_flows.yml")
    ...
    def validate_artifact_accessible(self, artifact_id: str, mode: str = 'read') -> bool:
        ...
        try:
            ...
            logger.debug(f"Artifact '{artifact_id}' accessible for {mode}: {accessible}")
            return accessible
    ...
    def list_artifacts(self, phase_id: Optional[str] = None, action: Optional[str] = None) -> list:
        """
