...
class DirectorySynchronizer:
    ...
    def _plan_mapping_operations(
        ...
        if operation == "delete":
            ...
            old_dir = self._get_directory_path(
                element_type, mapping.old_sequence, element_id, parent_path
            )
            ...
            new_dir = self._get_directory_path(
                element_type, mapping.new_sequence, element_id, parent_path
            )
    ...
    def _get_directory_path(
        ...
        dir_name = self.naming_pattern.format(
            element=element_type, sequence=sequence, name=dir_name_part
        )
