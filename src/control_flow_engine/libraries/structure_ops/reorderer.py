...
class StructureReorderer:
    ...
    def reorder_elements(
        ...
        operation = ReorderOperation(
            original_order=original_order, new_order=new_order, parent_path=element_path
        )
        ...
        try:
            ...
            return ReorderResult(
                success=False, operation=operation, errors=[f"Reorder failed: {str(e)}"]
            )
    ...
    def reorder_by_ids(
        ...
        try:
            ...
            return ReorderResult(
                success=False, errors=[f"Unknown element ID in id_order: {e}"]
            )
    ...
    def _validate_reorder(
        self, parent_list: List[Dict], operation: ReorderOperation
    ) -> List[str]:
    ...
    def _calculate_mappings(
        self, parent_list: List[Dict], new_order: List[int]
    ) -> List[ReorderMapping]:
