...
def test_project(tmp_path):
    ...
    for phase_num in [1, 2, 3, 5]:
        ...
        readme.write_text(f"# Phase {phase_num}: Test Phase\n\nThis is phase {phase_num}.")
...
class TestPlanCreation:
    ...
    def test_plan_insert_phase(self, test_project):
        ...
        renumberer = PhaseStepRenumberer(test_project, strategy=NumberingStrategy.MINIMAL_SHIFT)
    ...
    def test_plan_remove_phase_compact(self, test_project):
        ...
        renumberer = PhaseStepRenumberer(test_project, strategy=NumberingStrategy.COMPACT)
