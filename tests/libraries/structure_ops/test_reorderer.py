...
class TestStructureReorderer:
    ...
    def test_reorder_basic(self):
        ...
        operation = ReorderOperation(
            new_order={1: 3, 2: 1, 3: 2}, element_path="items"  # Rotate
        )
    ...
    def test_reorder_by_ids(self):
        ...
        result = reorderer.reorder_by_ids(
            structure, operation, ["item3", "item2", "item1"]
        )
    ...
    def test_reorder_partial(self):
        ...
        reorderer = StructureReorderer()
        operation = ReorderOperation(
            new_order={1: 3, 3: 1}, element_path="items"  # Only swap 1 and 3
        )
    ...
    def test_dry_run(self):
        ...
        reorderer = StructureReorderer()
        operation = ReorderOperation(new_order={1: 2, 2: 1}, element_path="items")
    ...
    def test_invalid_new_order(self):
        ...
        reorderer = StructureReorderer()
        operation = ReorderOperation(
            new_order={1: 99}, element_path="items"  # 99 doesn't exist
        )
    ...
    def test_reorder_by_ids_extra_id(self):
        ...
        result = reorderer.reorder_by_ids(structure, operation, ["item1", "item2"])
