...
class TestStructureSwapper:
    ...
    def test_swap_basic(self):
        ...
        operation = SwapOperation(
            element_a_id="item1", element_b_id="item3", element_path="items"
        )
    ...
    def test_swap_adjacent(self):
        ...
        swapper = StructureSwapper()
        operation = SwapOperation(
            element_a_id="item1", element_b_id="item2", element_path="items"
        )
    ...
    def test_swap_same_element_error(self):
        ...
        swapper = StructureSwapper()
        operation = SwapOperation(
            element_a_id="item1", element_b_id="item1", element_path="items"
        )
    ...
    def test_invalid_element_id(self):
        ...
        swapper = StructureSwapper()
        operation = SwapOperation(
            element_a_id="item1", element_b_id="nonexistent", element_path="items"
        )
