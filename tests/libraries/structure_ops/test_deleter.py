...
class TestStructureDeleter:
    ...
    def test_delete_basic(self):
        ...
        operation = DeleteOperation(element_id="item2", element_path="items")
    ...
    def test_delete_without_cascade(self):
        ...
        deleter = StructureDeleter()
        operation = DeleteOperation(
            element_id="item2", cascade_renumber=False, element_path="items"
        )
    ...
    def test_delete_first_element(self):
        ...
        deleter = StructureDeleter()
        operation = DeleteOperation(
            element_id="item1", cascade_renumber=True, element_path="items"
        )
    ...
    def test_deleted_element_stored(self):
        ...
        structure = {"items": [{"id": "item1", "sequence": 1, "data": "important"}]}

        deleter = StructureDeleter()
        operation = DeleteOperation(element_id="item1", element_path="items")
    ...
    def test_invalid_element_id(self):
        ...
        deleter = StructureDeleter()
        operation = DeleteOperation(element_id="nonexistent", element_path="items")
